...
- 🔄 **Ранжирование по месяцам**
  ...
  - Сравнение месяцев (январь 2024 vs январь 2025)
  - График динамики расходов за год

- 🔄 **Фильтрация по категориям**
  - Множественный выбор категорий для анализа
  - Сравнение категорий между собой
  - Drill-down: детализация транзакций по категории

- 🔄 **Оптимизация графиков**
  - Адаптивное масштабирование осей (автоподбор диапазона)

...
- 📋 **Автоопределение даты/времени по геолокации**
  - Автоматическая установка часового пояса на основе GPS координат
  - Корректное время транзакций при путешествиях за границу
  - Определение региона для локализации валюты и форматов
  - Кэширование последнего местоположения для офлайн режима
  - Использование `geolocator` + `timezone` пакетов

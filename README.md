...
```
┌─────────────────────────────────────┐
│  🟠 Привет, Tim            🔔       │ ← Оранжевый header с аватаром
├─────────────────────────────────────┤
│  ┌─────────────────────────────┐    │
│  │  Общий баланс               │    │
│  │  25,000 ₽                   │    │ ← Тёмная карточка (#1E1E2E)
│  │  Расходы текущего месяца    │    │
│  │  ████████████░░░ 50%        │    │ ← Прогресс-бар бюджета
│  │  ┌──────────┐ ┌──────────┐  │    │
│  │  │↑ 45,000₽ │ │↓ 20,000₽│  │    │ ← Доходы / Расходы
│  │  │  Доходы  │ │ Расходы │  │    │
│  │  └──────────┘ └──────────┘  │    │
│  └─────────────────────────────┘    │
├──────────────────┬──────────────────┤
│  + Добавить      │  📷 Сканировать  │ ← Разделённые кнопки
├─────────────────────────────────────┤
...
- 🔄 **Предобработка изображений для OCR** (OpenCV)
  - Бинаризация с адаптивным порогом (метод Otsu)
  - Увеличение контраста и удаление шума
  - Коррекция угла наклона (deskew)
  - **Ожидаемое улучшение:** OCR точность 60-70% → 85-95%
...
- 🔄 **Оптимизация дизайна и брендинг**
  - Разработка профессионального логотипа (SVG/PNG)
  - Обновление цветовой палитры (частично выполнено)
  - Улучшение типографики и анимаций
...
- 🔄 **Push-уведомления**
  ...
  - Предупреждения о превышении бюджета (90%, 100%, 110%)
  - Еженедельный отчёт
